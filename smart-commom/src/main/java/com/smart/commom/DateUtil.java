...
public class DateUtil {
	...
	public final static SimpleDateFormat sdfDateTimeFormat_IIIII = new SimpleDateFormat("HHmmss");
	 ...
	 * @return
	 */
	public static String getTimeStrHHmmss(Date date) {
		if (date == null) {
			return "";
		}
		return sdfDateTimeFormat_IIIII.format(date);
	}
	 ...
	 * @since JDK 1.8
	 */
	public static String getDateStrYYMMDD() {
		Date date = new Date();
		String str = g_SimpleDateFormat.format(date);
	...
	public static void main(String[] args) {
		System.out.println(getDateStrYYMMDD());
	}
