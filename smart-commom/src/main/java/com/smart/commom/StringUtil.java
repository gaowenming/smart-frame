...
public class StringUtil {
	 ...
	 * @since JDK 1.8
	 */
	public static String addZeroLeft(int number, int length) {
	 ...
	 * @since JDK 1.8
	 */
	public static String getRandomStrByDateAndChar() {
		long time = System.currentTimeMillis();
		return time + "" + getRandomIntNum(12);
	}

	public static void main(String[] args) {
		System.out.println(addZeroLeft(8976, 7));
		System.out.println(getRandomStrByDateAndChar());
	}
